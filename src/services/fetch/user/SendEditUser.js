import {API_USER_INFORMATION_UPDATE} from "../../../../UrlConstants.jsx";
import {throwSpecifyException} from "../../../exception/ThrowSpecifyException.jsx";
import {tryToRefreshJwt} from "../jwt/RefreshJwt.js";
import UnauthorizedException from "../../../exception/UnauthorizedException.jsx";


export const sendEditUser = async (editData) => {
    let response = await fetch(API_USER_INFORMATION_UPDATE, {
        method: 'PATCH',
        headers: {
    ...
    if (!response.ok) {
        ...
        if (error.status === 401) {
            ...
            try {
                ...
                return await sendEditUser(editData);
            } catch (in_error) {

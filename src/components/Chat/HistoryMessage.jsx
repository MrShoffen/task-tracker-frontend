...
export function HistoryMessage({history}) {
    ...
    >
        ...
        <Box sx={{ml: '10px', mr: '10px', mt: '0px'}}>
            <Typography component='span' fontSize='0.7rem' color='message_history'>
                ...
                <Box display={'inline-flex'} flexDirection={'row'}>
                    ...
                    >
                        ...
                        <Typography component='span' fontWeight='600' fontSize='0.7rem' color='message_history'>
                            {userInfo.email}
                        </Typography>
                    </Box>
                ...
                {history.type === 'TASK_CREATED' &&
                    ...
                    > {' создал задачу '}
                        ...
                        > {history.additionalInfo.taskName}
                            <Typography component='span' fontSize='0.7rem' color='message_history'>{' на доске '}
                                <Typography component='span' fontWeight='600' fontSize='0.7rem'
                                            color='message_history'>
